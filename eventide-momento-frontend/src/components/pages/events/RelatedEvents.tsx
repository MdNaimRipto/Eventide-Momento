...
const RelatedEvents = () => {
  ...
  const lines = ["Discover", "Related Events"];
  if (isLoading)
    return (
      <div className="container pb-16 px-2 md:px-4 xl:px-16">
        <h1
          className={`text-secondary1 text-4xl md:text-5xl mb-8 flex flex-col whitespace-nowrap tracking-[.95px] ${LocalFonts.anton.className}`}
        >
          {lines.map((line, i) => (
